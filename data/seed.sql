...
INSERT INTO marked_entities (title, description, lecture_id, is_group_work, due_at, created_at, updated_at) values ('Assignment 1' ,  'Desc for assignment 1',  1,  1 ,  now() + INTERVAL 10 DAY , now() ,  now() )