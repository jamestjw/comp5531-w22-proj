...
<!-- This section deals with submission of the entered data.-->
    <?php if (isset($_POST['submitCourse'])) {
        ...
        $section->course_id = $_POST['course_selection'];
    ...
    <?php if (isset($_POST['submitCourse']) || isset($_POST['submitSection']) && isset($create_success) && $create_success) {
...
<!--Sections-->
        ...
        <?php elseif (count($result_courses) > 0):?>
            <b>No sections found. Add a course section:</b>
            <br>
            <form method="post">
        ...
        <?php else:?>
            <b>Please add a course before adding an section.</b>
        <?php endif?>
