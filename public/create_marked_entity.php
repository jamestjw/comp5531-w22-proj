...
if (!isset($_POST["course_section_id"])) {
    die("Invalid course section.");
}

$course_section_id = intval($_POST["course_section_id"]);
// TODO: Check if the user is indeed an instructor of this course
// when instructors of courses are assigned.
if (is_null(CourseSection::find_by_id($course_section_id))) {
    die("Invalid course section.");
}
...
$marked_entity->course_section_id = $course_section_id;
